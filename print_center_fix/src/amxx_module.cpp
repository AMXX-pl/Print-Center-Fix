...
{
#ifdef _WIN32
	const auto* const mask = "xxxxxx????x";
	const auto* const pattern = "\xFF\x73\x08\xFF\x37\xE8\x00\x00\x00\x00\x83";
...
{
#ifdef _WIN32
	const auto* const mask = "xxxx????xxx";
	const auto* const pattern = "\x56\xFF\x30\xE8\x00\x00\x00\x00\x83\xC4\x0C";
